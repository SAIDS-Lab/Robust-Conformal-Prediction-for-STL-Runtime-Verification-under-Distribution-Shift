...
position_std = 0.1  # Comment added after data collected: This is really the radius of sampling not std, but I named it std here in the original codes.
...
def save_trajectories(trajectories):
    ...
    with open("original_17.json", "w") as outfile:
